package com.example.fix.books.Tutorial;
...
public class ProductTourActivity extends AppCompatActivity {
    ...
    private void buildCircles() {
        ...
        for (int i = 0; i < NUM_PAGES - 1; i++) {
            ...
            circle.setImageResource(R.drawable.ic_fiber_manual_record_black_18dp);
    ...
    public class CrossfadePageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            View object14 = page.findViewById(R.id.a014);
...
//                }
                ...
                if (object14 != null) {
                    ViewHelper.setTranslationX(object14, (float) (pageWidth / 1.5 * position));
                }
